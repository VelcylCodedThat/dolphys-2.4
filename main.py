...
def credits():
    print("Fully developed by Aditya Bhide, except for the currency conversion tables. That was made by someone else. Credit to the developer of matplotlib, Michael Droettboom, for the actual graphing interface.")
def main():
    while True:
        print("Note: Currency tables may be inaccurate. Please use at your own risk.")
        print("Dolphys")
